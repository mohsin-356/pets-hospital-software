  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        <h1 className="text-3xl font-bold bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">Doctor Profile</h1>
      ...
      <div className="rounded-2xl bg-gradient-to-br from-white to-blue-50 shadow-xl ring-1 ring-blue-200/50 p-6 border border-blue-100">
        <form onSubmit={save} className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input className="h-12 px-4 rounded-xl border-2 border-slate-200 focus:border-blue-400 focus:ring-4 focus:ring-blue-100 w-full transition-all duration-200 bg-white shadow-sm" placeholder="Enter your full name" value={form.name} onChange={e=>setForm(s=>({...s,name:e.target.value}))} required />
          </div>
          <div>
            <label className="block text-sm font-semibold text-blue-700 mb-2 flex items-center gap-2">
            ...
            <input className="h-12 px-4 rounded-xl border-2 border-slate-200 focus:border-blue-400 focus:ring-4 focus:ring-blue-100 w-full transition-all duration-200 bg-white shadow-sm" placeholder="e.g., Veterinary Medicine" value={form.specialization} onChange={e=>setForm(s=>({...s,specialization:e.target.value}))} />
          </div>
          <div>
            <label className="block text-sm font-semibold text-blue-700 mb-2 flex items-center gap-2">
            ...
            <input className="h-12 px-4 rounded-xl border-2 border-slate-200 focus:border-blue-400 focus:ring-4 focus:ring-blue-100 w-full transition-all duration-200 bg-white shadow-sm" placeholder="e.g., $100" value={form.fee} onChange={e=>setForm(s=>({...s,fee:e.target.value}))} />
          </div>
          <div>
            <label className="block text-sm font-semibold text-blue-700 mb-2 flex items-center gap-2">
            ...
            <input className="h-12 px-4 rounded-xl border-2 border-slate-200 focus:border-blue-400 focus:ring-4 focus:ring-blue-100 w-full transition-all duration-200 bg-white shadow-sm" placeholder="Your contact number" value={form.phone} onChange={e=>setForm(s=>({...s,phone:e.target.value}))} />
          </div>
          <div>
            <label className="block text-sm font-semibold text-blue-700 mb-2 flex items-center gap-2">
            ...
            <input type="email" className="h-12 px-4 rounded-xl border-2 border-slate-200 focus:border-blue-400 focus:ring-4 focus:ring-blue-100 w-full transition-all duration-200 bg-white shadow-sm" placeholder="your.email@example.com" value={form.email} onChange={e=>setForm(s=>({...s,email:e.target.value}))} />
          </div>
          <div className="md:col-span-2">
            ...
            <input className="h-12 px-4 rounded-xl border-2 border-slate-200 focus:border-blue-400 focus:ring-4 focus:ring-blue-100 w-full transition-all duration-200 bg-white shadow-sm" placeholder="Your clinic/practice address" value={form.address} onChange={e=>setForm(s=>({...s,address:e.target.value}))} />
          </div>
          ...
          <div className="md:col-span-2 mt-4">
            <button className="px-8 h-14 rounded-xl bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white font-bold cursor-pointer transition-all duration-200 shadow-lg hover:shadow-xl flex items-center gap-3 text-lg">
      ...
      {showThanks && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center animate-fadeIn" onClick={()=>setShowThanks(false)}>
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md ring-1 ring-blue-200 overflow-hidden transform transition-all animate-slideUp" onClick={e=>e.stopPropagation()}>
            <div className="bg-gradient-to-r from-blue-500 to-cyan-600 px-6 py-8 text-center">
              ...
              <div className="text-blue-50">Your profile has been saved successfully</div>
            </div>
            <div className="px-6 py-6 text-center bg-gradient-to-b from-white to-blue-50">
              ...
              <button 
                ...
                className="px-8 h-12 rounded-xl bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white font-semibold cursor-pointer transition-all duration-200 shadow-lg hover:shadow-xl"
              >
                Got it, thanks!
              </button>
            </div>
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center animate-fadeIn" onClick={()=>setShowLoginError(false)}>
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md ring-1 ring-blue-200 overflow-hidden transform transition-all animate-slideUp" onClick={e=>e.stopPropagation()}>
            <div className="bg-gradient-to-r from-blue-500 to-cyan-600 px-6 py-8 text-center">
              ...
              <div className="text-blue-50">Authentication needed</div>
            </div>
            <div className="px-6 py-6 text-center bg-gradient-to-b from-white to-blue-50">
