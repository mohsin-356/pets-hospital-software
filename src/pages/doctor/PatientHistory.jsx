  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">Patient History</h1>
          ...
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div className="px-3 py-1 bg-blue-100 rounded-lg border border-blue-200">
                <span className="text-blue-700 font-semibold text-sm">{history.length} Prescriptions</span>
              </div>
            </div>
      ...
      <div className="rounded-2xl bg-gradient-to-br from-white to-blue-50 shadow-xl ring-1 ring-blue-200/50 p-6 border border-blue-100">
        <div className="flex items-center gap-2 mb-6">
          <svg className="w-6 h-6 text-blue-600" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M4 4a2 2 0 00-2 2v4a2 2 0 002 2V6h10a2 2 0 00-2-2H4zm2 6a2 2 0 012-2h8a2 2 0 012 2v4a2 2 0 01-2 2H8a2 2 0 01-2-2v-4zm6 4a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" /></svg>
          <div className="text-blue-800 font-bold text-xl">Prescription History</div>
        </div>
        {history.length === 0 && (
        ...
        <div className="space-y-4">
          {history.map((h, i) => (
            <div key={i} className="group rounded-2xl border-2 border-blue-200 hover:border-blue-300 p-5 bg-gradient-to-br from-white to-blue-50/30 shadow-lg hover:shadow-xl transition-all duration-200">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="px-3 py-1 bg-blue-100 rounded-lg border border-blue-200">
                  <span className="text-blue-700 font-semibold text-sm">{(h.items || []).length} medicines</span>
                </div>
              </div>
              <div className="space-y-3">
                {(h.items || []).map((it, idx) => (
                  <div key={idx} className="bg-gradient-to-r from-slate-50 to-blue-50/50 rounded-xl p-4 border border-slate-200">
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-2">
                        <span className="px-2 py-1 bg-blue-100 text-blue-700 rounded-md text-xs font-semibold">{it.route || 'Oral'}</span>
